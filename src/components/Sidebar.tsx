          ...
          <div className="flex-1 overflow-y-auto">
            <ul className="space-y-0.5 py-2">
              ...
              <li className="border-t border-gray-300 dark:border-gray-700">
                ...
                <ul id="dropdown-persons" className="hidden py-2 space-y-2">
                  <li>
                    <Link
              ...
              <li className="border-t border-gray-300 dark:border-gray-700">
                ...
                <ul id="dropdown-purchases" className="hidden py-2 space-y-2">
                  <li>
                    <Link
              ...
              <li className="border-t border-gray-300 dark:border-gray-700">
                ...
                <ul id="dropdown-quotes" className="hidden py-2 space-y-2">
                  <li>
                    <Link
              ...
              <li className="border-t border-gray-300 dark:border-gray-700">
                ...
                <ul id="dropdown-guides" className="hidden py-2 space-y-2">
                  <li>
                    <Link
              ...
              <li className="border-t border-b border-gray-300 dark:border-gray-700">
                ...
                <ul id="dropdown-retentions" className="hidden py-2 space-y-2">
                  <li>
                    <Link
