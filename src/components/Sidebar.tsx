...
function Sidebar() {
    ...
    const handleMenuToggle = (menuId: string) => {
        ...
        if (activeMenu === menuId) {
            ...
            // Si es diferente, cerramos el anterior y abrimos el nuevo
            if (activeMenu) {
    ...
    return (
        <>
            <aside
                id="sidebar"
                className={`fixed top-16 inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 transition-transform transform mt-16 font-encodeSansCondensed border-r border-gray-200 dark:border-gray-700 ${
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                        <div className="text-sm font-medium">Empresa: {u?.companyId}</div>
                    ...
                    <div className="flex-1 overflow-y-auto">
                        <ul className="space-y-0.5 py-2">
                            ...
                            <li>
                                <button
                                    type="button"
                                    className="flex items-center w-full py-1.5 px-4 text-sm text-gray-900 transition-colors hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                    onClick={() => handleMenuToggle('dropdown-layouts')}
                                >
                                    <svg
                            ...
                            <li>
                                <button
                                    type="button"
                                    className="flex items-center w-full py-1.5 px-4 text-sm text-gray-900 transition-colors hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                    onClick={() => handleMenuToggle('dropdown-crud')}
                                >
                                    <svg
                                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="currentColor"
                            ...
                            <li>
                                <button
                                    ...
                                    onClick={() => handleMenuToggle('dropdown-persons')}
                                >
                            ...
                            <li>
                                <button
                                    ...
                                    onClick={() => handleMenuToggle('dropdown-purchases')}
                                >
                                    <svg
                                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        aria-hidden="true"
                            ...
                            <li>
                                <button
                                    ...
                                    onClick={() => handleMenuToggle('dropdown-quotes')}
                                >
                                    <svg
                                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="none"
                            ...
                            <li>
                                <button
                                    ...
                                    onClick={() => handleMenuToggle('dropdown-sales')}
                                >
                                    <svg
                                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="currentColor"
                            ...
                            <li>
                                <button
                                    ...
                                    onClick={() => handleMenuToggle('dropdown-guides')}
                                >
                                    <svg
                                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="none"
                            ...
                            <li>
                                <button
                                    ...
                                    onClick={() => handleMenuToggle('dropdown-retentions')}
                                >
                                    <svg
                                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="none"
                    ...
                    <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">www.4soluciones.net</div>
                        <div className="text-sm font-medium mt-1">SISTEMAS DE TECNOLOGIA 4 SOLUCIONES S.A.C.</div>
                    </div>
                </div>
            </aside>
