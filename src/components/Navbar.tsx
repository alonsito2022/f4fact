...
function Navbar() {
    ...
    return (
        <div className="sticky top-0 z-30 w-full">
            <HeaderAnnouncement />
            <nav
                className={`w-full h-16 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 font-encodeSansCondensed transition-all duration-300 ease-in-out ${
