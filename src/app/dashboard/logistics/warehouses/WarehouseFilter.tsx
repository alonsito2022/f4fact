        ...
        <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <div className="flex items-center mb-4 sm:mb-0">
                <form className="sm:pr-3" action="#" method="GET">
                    ...
                    <select
                        value={searchField}
                        onChange={(e) => setSearchField(e.target.value as 'name' | 'subsidiaryName')}
                        className=" form-control"
                    >
            ...
            <button id="createProductButton" type="button" onClick={(e) => { modal.show(); setWarehouse(initialState); }} className="btn-blue px-5 py-3 inline-flex items-center gap-2"><Add />Crear almacen</button>
        </div>
    )
}
