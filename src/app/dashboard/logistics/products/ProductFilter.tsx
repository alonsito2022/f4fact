                ...
                <form className="sm:pr-3" action="#" method="GET">
                    ...
                    <div className="relative w-48 mt-1 sm:w-64 xl:w-96 inline-flex gap-2">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setSearchField(
                                    e.target.value as "name" | "code" | "ean"
                                )
                            }
                            className=" form-control"
                            disabled
                ...
                <div className="flex items-center w-full sm:justify-end">
                    <div className="flex pl-2 space-x-1">
                        <a
                            ...
                            className="inline-flex items-center justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                        >
                            <Filter />
                        </a>
                        <a
