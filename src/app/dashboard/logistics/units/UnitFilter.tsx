...
function UnitFilter({searchTerm, setSearchTerm, searchField, setSearchField, modal, initialState, setUnit}:any) {
        ...
        <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <div className="flex items-center mb-4 sm:mb-0">
                <form className="sm:pr-3" action="#" method="GET">
                    ...
                    <select
                        value={searchField}
                        onChange={(e) => setSearchField(e.target.value as 'shortName' | 'code')}
                        className=" form-control"
                    >
            ...
            <button id="createProductButton" type="button" onClick={(e) => { modal.show(); setUnit(initialState); }} className="btn-blue px-5 py-3 inline-flex items-center gap-2"><Add />Crear Unidad</button>
        </div>
    )
}
