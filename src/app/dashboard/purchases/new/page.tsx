                                ...
                                <div className="flex justify-end py-2">
                                    <button
                                        ...
                                        onClick={async () => {
                                            ...
                                            if (purchase.serial.length === 0) {
                                                toast(
                                                    "Por favor ingrese una serie.",
                                                    {
                                                        hideProgressBar: true,
                                                        autoClose: 2000,
                                                        type: "warning",
                                            ...
                                            if (
                                                Number(purchase.correlative) ===
                                                0
                                            ) {
                                                toast(
                                                    "Por favor ingrese un correlativo.",
                                                    {
                                                        hideProgressBar: true,
                                                        autoClose: 2000,
                                                        type: "warning",
