                    ...
                    <table className="w-full text-xs text-left text-gray-700 dark:text-gray-200">
                        <thead>
                            <tr className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 text-[11px] uppercase">
                                ...
                                <th className="px-2 py-2 font-semibold">Razon Social</th>
                                ...
                                <th className="px-2 py-2 font-semibold">Límite</th>
                                <th className="px-2 py-2 font-semibold">Prod.</th>
                            ...
                            {companies?.map((item: ICompany) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-2 py-1 truncate max-w-[80px]">{item.doc}</td>
                                        <td className="px-2 py-1 truncate max-w-[120px]">{item.businessName}</td>
                                        <td className="px-2 py-1 truncate max-w-[80px]">{item.shortName}</td>
                                        <td className="px-2 py-1 truncate max-w-[100px]">{item.address}</td>
                                        <td className="px-2 py-1 truncate max-w-[70px]">{item.phone}</td>
                                        <td className="px-2 py-1 truncate max-w-[100px]">{item.email}</td>
                                        <td className="px-2 py-1">{item.limit}</td>
