...
function CompanyFilter({searchTerm, setSearchTerm, modal}:any) {
  ...
  return (
    ...
    <div className="flex items-center mb-4 sm:mb-0">
        <form className="sm:pr-3" action="#" method="GET">
            ...
            <div className="relative w-48 mt-1 sm:w-64 xl:w-96">
                <input type="text" name="searchTerm" id="products-search" value={searchTerm} onChange={handleInputSearchChange} 
    ...
    <button id="createCompanyButton" type="button" onClick={(e) => { modal.show(); }} className="btn-blue">Crear Empresa</button>
</div>
  )
}
