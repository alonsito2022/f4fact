                                                    ...
                                                    <div className="flex flex-col items-center justify-center p-2">
                                                        {company?.logo?.length ?
                                                            ...
                                                            <>
                                                                ...
                                                                <p className="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX. 300x300px)</p>
                                                            </>}
                                                    </div>
                                ...
                                <fieldset>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        ...
                                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                                            ...
                                            <label htmlFor="deductionAccount" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Cuenta de tracción(BN)</label>
                                        </div>
