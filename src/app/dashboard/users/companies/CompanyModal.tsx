...
function CompanyModal({
  ...
  const validateCompanyData = (companyData: ICompany): string[] => {
    ...
    if (
      !companyData.registerDate ||
      companyData.registerDate.trim().length < 10
    ) {
      errors.push(
        "La fecha de registro es requerida y debe tener al menos 10 caracteres"
      );
    }
    if (
      !companyData.certificationExpirationDate ||
      companyData.certificationExpirationDate.trim().length < 10
    ) {
      errors.push(
        "La fecha de expiracion es requerida y debe tener al menos 10 caracteres"
      );
    }
  ...
  const handleSaveCompany = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const commonVariables = {
        ...
        showUser: company.showUser || false,
      };
      ...
      // Error de red (incluyendo 400)
        ...
        if (error.networkError.statusCode === 400) {
          try {
            ...
            errorMessage =
              errorBody.message || "Datos inválidos enviados al servidor";
        ...
        if (e.target?.result) {
          ...
          img.onload = () => {
            if (img.width > 300 || img.height > 300) {
              toast.error("La imagen no debe superar los 300x300 píxeles", {
                hideProgressBar: true,
                autoClose: 2000,
              });
              handleFileReset(); // Restablece el input de archivo
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="relative z-0 w-full mb-2 group sm:col-span-1">
                          <input
                            ...
                            name="shortName"
                            id="shortName"
                            value={company?.shortName ? company?.shortName : ""}
                            onChange={handleInputChange}
                            onFocus={(e) => e.target.select()}
                            className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" "
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <input
                            ...
                            name="userSol"
                            id="userSol"
                            value={company?.userSol ? company?.userSol : ""}
                            onChange={handleInputChange}
                            onFocus={(e) => e.target.select()}
                            className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" "
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <input
                            ...
                            name="keySol"
                            id="keySol"
                            value={company?.keySol ? company.keySol : ""}
                            onChange={handleInputChange}
                            onFocus={(e) => e.target.select()}
                            className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" "
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <input
                            type="date"
                            value={
                              company?.registerDate ? company?.registerDate : ""
                            }
                            onChange={handleInputChange}
                            name="registerDate"
                        ...
                        <div className="sm:col-span-3 relative z-0 w-full mb-2 group">
                          ...
                          {company.certificationKey && (
                            <p className="text-sm text-orange-500 font-bold mt-1">
                              Archivo cargado: server_key.pem
                            </p>
                          )}
                        </div>
                      </div>
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              checked={
                                company?.isEnabled ? company?.isEnabled : false
                              }
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              checked={
                                company?.withStock ? company?.withStock : false
                              }
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              checked={
                                company?.invoiceF ? company?.invoiceF : false
                              }
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              checked={
                                company?.invoiceB ? company?.invoiceB : false
                              }
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              name="guide"
                              className="sr-only peer"
                              checked={company?.guide ? company?.guide : false}
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              name="app"
                              className="sr-only peer"
                              checked={company?.app ? company?.app : false}
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              checked={company.disableContinuePay || false}
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              checked={company.isAgentRetention || false}
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              checked={company.isAgentPerception || false}
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                        ...
                        <div className="sm:col-span-1 relative z-0 w-full mb-2 group">
                          <label className="inline-flex items-center mb-1 cursor-pointer">
                            <input
                              ...
                              name="showUser"
                              className="sr-only peer"
                              checked={company.showUser || false}
                              onChange={handleCheckboxChange}
                            />
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-500 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">
