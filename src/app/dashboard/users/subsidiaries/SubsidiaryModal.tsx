...
function SubsidiaryModal({
  ...
  const refreshSubsidiaryData = async (subsidiaryId: number) => {
    ...
    if (subsidiaryData.subsidiaryById) {
      const subsidiaryFound = {
        ...
        serialassignedSet: subsidiaryData.subsidiaryById.serialassignedSet?.map(
          (item: any) => ({
            ...item,
  ...
  const handleSaveSubsidiary = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const pdfFormatForExitNotes = subsidiary.pdfFormatForExitNotes || 1;
      ...
      queryFetch = `
                mutation{
                    updateSubsidiary(
                        ...
                        pdfFormatForExitNotes: ${pdfFormatForExitNotes},
                        fillColor: "${fillColor}"
                    ){
                        message
                    }
            ...
            <div className="p-4 md:p-5">
              <form onSubmit={handleSaveSubsidiary}>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex-grow relative">
                          <input
                            ...
                            name="fillColor"
                            id="fillColor"
                            value={subsidiary.fillColor || "#D2D7DA"}
                            onChange={handleInputChange}
                ...
                {Number(subsidiary.id) > 0 && (
                  <SerialAssignedTable
                    serialassignedSet={subsidiary.serialassignedSet || []}
                  ...
                  <div className="grid gap-4">
                    <div className="flex flex-col space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        value={subsidiary.pdfFormatForInvoices}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      >
                        <option value={1}>Tamaño A4</option>
                        {/* <option value={2}>
                                                    Tamaño A5 (Mitad de A4)
                                                </option> */}
                        <option value={3}>Tamaño Ticketera</option>
                      </select>
                    </div>
                    <div className="flex flex-col space-y-2">
                      <label className="block text-sm font-medium text-gray-900 dark:text-white">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        value={subsidiary.pdfFormatForReceiptInvoices}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      >
                        <option value={1}>Tamaño A4</option>
                        {/* <option value={2}>
                    ...
                    <div className="flex flex-col space-y-2">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        value={subsidiary.pdfFormatForGuides}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      >
                        <option value={1}>Tamaño A4</option>
                        {/*<option value={2}>
                    ...
                    <div className="flex flex-col space-y-2">
                      <label className="block text-sm font-medium text-gray-900 dark:text-white">
                        Formato de PDF en Notas de Salida
                      </label>
                      <select
                        name="pdfFormatForExitNotes"
                        onChange={handleInputChange}
                        value={subsidiary.pdfFormatForExitNotes}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      >
                        <option value={1}>Tamaño A4</option>
                        {/*<option value={2}>
                ...
                >
                  {subsidiary.id ? "Actualizar Local" : "Crear Local"}
                </button>
              </form>
            </div>
          </div>
