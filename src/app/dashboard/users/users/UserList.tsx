...
function UserList({ users, modal, setModal, user, setUser, userLogged }: any) {
            ...
            <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    {users
                        .filter(
                            (u: IUser) =>
                                userLogged.subsidiaryId === "0" || // Si es superusuario, muestra todos
                                Number(u?.subsidiary?.id) ===
                                    Number(userLogged.subsidiaryId) // Si no, filtra por sucursal
                        )
                        .map((item: IUser) => (
                            <tr
                                key={item.id}
                                            ...
                                            <ImageCircle
                                                image={
                                                    ...
                                                    (
                                                        ...
                                                        ? `${process.env.NEXT_PUBLIC_BASE_API}/${item.avatarUrl}`
                                                        : (item.avatarUrl as string)
                                                }
                                            />
                                        </>
