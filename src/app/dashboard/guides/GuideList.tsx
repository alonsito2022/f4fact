        ...
        <div className="flex flex-wrap items-center gap-4 my-3 pl-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              disabled
              readOnly
              defaultValue={guidesData?.allGuides?.totalNumberOfPages}
              className="form-control-sm w-16 text-center"
            />
          </div>
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              disabled
              readOnly
              defaultValue={guidesData?.allGuides?.totalNumberOfSales}
              className="form-control-sm w-16 text-center"
            />
          </div>
          <SalePagination
        ...
        <table className="w-full border-collapse border border-gray-100 dark:border-gray-600">
          <thead className="bg-gray-100 dark:bg-gray-700 text-[13px] text-black-500 uppercase dark:text-gray-400">
            <tr>
              {user?.isSuperuser && (
                <>
                  <th className="p-0.5 w-4 dark:border-gray-600">Id</th>
                  <th className="p-0.5 w-80 dark:border-gray-600">Empresa</th>
                </>
              )}
              <th className="p-0.5 pl-2 w-4 dark:border-gray-600 text-left">
                Fecha
              </th>
              <th className="p-0.5 w-4 dark:border-gray-600">Tipo</th>
              ...
              <th className="p-0.5 w-80 dark:border-gray-600">Entidad</th>
              <th className="p-0.5 w-4 dark:border-gray-600">
                Enviado <br />
                al
                <br /> Cliente
              </th>
              <th className="p-0.5 pr-2 w-8 dark:border-gray-600">PDF</th>
              <th className="p-0.5 pr-2 w-8 dark:border-gray-600">XML</th>
              <th className="p-0.5 pr-2 w-8 dark:border-gray-600">CDR</th>
          ...
          <tbody className="text-[13px] [&>tr:nth-child(even)]:bg-gray-100 dark:[&>tr:nth-child(even)]:bg-gray-800">
            {transformedSalesData?.map((item: IOperation, index: number) => (
              ...
              >
                ...
                <td className="p-0.5 text-nowrap">{item.client?.names}</td>
                ...
                <td className="p-0.5 text-center">
                  {(item.documentType === "09" || item.documentType === "31") &&
                      ...
                      <Popover id={"popover-options-" + item.id}>
                        ...
                        {item.operationStatus !== "06" && (
                          <>
                            ...
                            >
                              INUTILIZAR GUÍA DE REMISION (INTERNO)
                            </a>
                            <br />
                          </>
                        )}
